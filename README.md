...
* [Mark Pilgrim](https://en.wikipedia.org/wiki/Mark_Pilgrim) and Kurt McKee for their work on the excellent [Universal Feed Parser](https://github.com/kurtmckee/feedparser) Python library.  This library was the inspiration for the `gofeed` library.
